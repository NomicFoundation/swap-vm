...
contract XYCConcentrateCapitalEfficiencyTest is Test, OpcodesDebug {
    ...
    function _quoteExactIn(ISwapVM.Order memory order, uint256 amountIn) internal view returns (uint256 amountOut) {
    ...
    function test_SameCapital_ConcentrateOutputBetter() public view {
        ...
        assertGt(concOut, xycOut, "Concentrate must give more output than XYCSwap for same capital");
        ...
        assertApproxEqRel(actualRatio, expectedRatio, 0.001e18, "Output ratio must match 2*(K+in)/(2K+in) formula");
    }
    ...
    function test_Slippage_ConcentrateRTimesLess() public view {
        ...
        assertGt(xycLoss, concLoss, "XYCSwap must have higher slippage loss than Concentrate for the same capital");
    ...
    function test_NarrowerRange_HigherCapitalEfficiency() public view {
        ...
        (ISwapVM.Order memory narrowOrder, ) = _concentrateOrder(
            capital,
            capital,
            SQRT_P_MIN_NARROW,
            SQRT_P_MAX_NARROW
